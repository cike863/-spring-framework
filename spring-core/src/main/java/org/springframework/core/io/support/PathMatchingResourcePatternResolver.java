...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
	...
	public static void main(String[] args) throws IOException {
		...
		pathMatchingResourcePatternResolver.getResources("classpath*:test/cc*/spring-*.xml");
		pathMatchingResourcePatternResolver.getResources("classpath*:test/aa/spring-*.xml");
	}
	@Override
